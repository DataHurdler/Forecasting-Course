...
\begin{frame}{The Update, in Pictures}
  ...
  \textbf{Our numbers:} the prior is centered on 0.10, the data say 0.15, and the posterior mean
...
\begin{frame}{Priors You Will Actually Use}
  ...
  \vspace{0.1cm}
  \muted{\footnotesize\itshape $\text{Beta}(5, 45)$ has mean $5/50 = 0.1$ --- a prior centered on
...
\begin{frame}{Did the Sampler Actually Work? \parencite{MartinKumarLao2021}}
  ...
  On the model above: $\hat{R} = 1.00$, ESS 3{,}686, zero divergences. \textbf{Report all three.}
\end{frame}
