...
[**The data-poor series moved 8.1 times further toward the group mean than the data-rich ones.**]{.key-result} Nobody told the model which series were thin. It inferred that from how much each series had to say.
...
| **RMSE against truth** | **0.126** | **0.048** | — |
