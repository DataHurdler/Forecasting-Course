...
**Our numbers:** the prior is centered on 0.10, the data say 0.15, and the posterior mean lands at [**0.14**]{.hi} — between them, nearer the data, because 200 observations outweigh a prior worth about 50.
...
[$\text{Beta}(5, 45)$ has mean $5/50 = 0.1$ — a prior centered on a 10% rate, worth about 50 observations of prior evidence.]{.neutral .smaller}
