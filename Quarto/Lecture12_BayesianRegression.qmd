...
On our fit, $P(\text{elasticity} < 0) = \mathbf{1.00}$ — the direction is not in doubt. But $P(\text{elasticity} < -0.5) = \mathbf{0.46}$: the data cannot settle whether demand is elastic or inelastic.
