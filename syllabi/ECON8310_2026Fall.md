...
(These were drafted with help from Claude.)<br>
...
2. **Use Favorita.** Daily sales for Corporación Favorita, a large Ecuadorian grocery chain,
   2013–2017, with promotions, store metadata, national holidays and a daily oil price. It is
   available now, it is documented in
   [`ECON8310_Datasets.md`](https://www.luozijun.com/forecasting-course/files/datasets.html), and
   it is different enough from the M5 data we use all term that you cannot reuse lecture code
   unchanged — which is the point. A Kaggle account is required to download it.

**A possible third option.** I am preparing a real, non-public sales panel from a working website.
If it is ready I will announce it by **Week 4**, when groups are due. If it is not, Favorita is the
supported fallback and you lose nothing — do not hold your project waiting for it.
...
Bring your dataset choice to the proposal in Week 9. If sourcing your own stalls, switch to
Favorita rather than losing weeks — tell me and it is not a penalty.
...
| In-class presentation | Week 16 (Dec. 17) | 25 |
...
**Online, asynchronous — no in-person meeting.** The lecture is posted as a recording **on Canvas**; the lab is self-paced and is on the course site. Office hours run as usual. Nothing is due this week, and Homework 3 is due the following week — so this is the week to work on it.
...
**Thanksgiving Week · Nov 26** — **no class**

**Week 14 · Dec 3** — Lecture 12: Bayesian Statistics III — Bayesian Linear Regression
...
**Week 15 · Dec 10** — Lecture 13: Synthesis — What the Semester Measured
*Reading:* FPP Ch. 13
**No lab this week.** The session is the course synthesis followed by project work time — bring your project and your questions.
*Due:* Homework 7

**Week 16 · Dec 17** — Final Exam Week: **final project presentations** (5:30-7:30pm)
