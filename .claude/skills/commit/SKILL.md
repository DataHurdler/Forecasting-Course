...
**Runs unconditionally.** The full backtest suite — all thirteen gates (surface-sync count claims like `"18 agents, 60 skills, 37 rules, 8 hooks"` and marked tables, skill integrity, model currency, links, site-index completeness, book-preface claims, assignment sync, spec conformance, staleness, repo hygiene, derived counts, ledger coverage, hook battery):
